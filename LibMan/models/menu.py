...
response.logo = A(B('LibMan'),XML('&trade;&nbsp;'),
                  _class="brand",_href="http://127.0.0.1:8000/LibMan/default/profile")
response.title = ' '.join(
...
response.menu += [
	...
	(T('Rate a Book'), False, URL('default', 'rate'),[]),
]
#response.menu = [
#	(T('FAQ\'s'), False, URL('default', 'faq'), [])
#]
